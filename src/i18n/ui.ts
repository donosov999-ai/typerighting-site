...
const es: Dict = {
  ...
  'rating.nav': 'Clasificación', 'rating.title': 'Clasificación', 'rating.sub': 'Los más rápidos — por disciplina e idioma',
  'rating.disc': 'Disciplina', 'rating.lang': 'Idioma', 'rating.player': 'Jugador', 'rating.acc': 'Precisión',
  'rating.loading': 'Cargando…', 'rating.empty': 'Aún no hay resultados — ¡sé el primero! Juega la competición en el entrenador.', 'rating.open': 'Abrir competición →',
  'disc.alpha_fwd': 'Alfabeto A→Z', 'disc.alpha_rev': 'Alfabeto Z→A', 'disc.words': 'Palabras', 'disc.digits': 'Dígitos', 'disc.sprint': 'Sprint',
  'learn.nav': 'Aprender', 'learn.title': 'Aprende mecanografía al tacto', 'learn.sub': 'Guías sobre mecanografía, velocidad y cómo aprender — hechos verificados, sin relleno.',
  'learn.cta': 'Practicar en el entrenador', 'learn.faq': 'Preguntas frecuentes', 'learn.sources': 'Fuentes',
  'demo.title': 'Pruébalo aquí mismo', 'demo.sub': 'Escribe la línea de abajo — siente cómo funciona, sin instalar',
  'demo.ph': 'Empieza a escribir aquí…', 'demo.full': 'Abrir el entrenador completo',
  'demo.save': 'Guarda tu progreso y entra en el ranking', 'demo.nick': 'Apodo',
  'demo.create': 'Crear cuenta', 'demo.openapp': 'Abrir entrenador →',
  'demo.ok': '¡Cuenta creada! Abre el entrenador e inicia sesión con tu apodo.',
  'demo.taken': 'Ese apodo está cogido — prueba otro', 'demo.short': 'Apodo ≥ 2 caracteres, PIN ≥ 4 dígitos',
  'demo.net': 'Error de red, inténtalo de nuevo',
};
const de: Dict = {
  ...
  'rating.nav': 'Rangliste', 'rating.title': 'Rangliste', 'rating.sub': 'Die schnellsten Tipper — nach Disziplin und Sprache',
  'rating.disc': 'Disziplin', 'rating.lang': 'Sprache', 'rating.player': 'Spieler', 'rating.acc': 'Genauigkeit',
  'rating.loading': 'Lädt…', 'rating.empty': 'Noch keine Ergebnisse — sei der Erste! Spiele den Wettbewerb im Trainer.', 'rating.open': 'Wettbewerb öffnen →',
  'disc.alpha_fwd': 'Alphabet A→Z', 'disc.alpha_rev': 'Alphabet Z→A', 'disc.words': 'Wörter', 'disc.digits': 'Ziffern', 'disc.sprint': 'Sprint',
  'learn.nav': 'Lernen', 'learn.title': 'Zehnfingerschreiben lernen', 'learn.sub': 'Ratgeber zum Zehnfingerschreiben, zur Geschwindigkeit und zum Lernen — Fakten geprüft, ohne Füllwerk.',
  'learn.cta': 'Im Trainer üben', 'learn.faq': 'Häufige Fragen', 'learn.sources': 'Quellen',
  'demo.title': 'Probier es gleich hier', 'demo.sub': 'Tippe die Zeile unten — spüre, wie es funktioniert, ohne Installation',
  'demo.ph': 'Hier tippen…', 'demo.full': 'Den vollen Trainer öffnen',
  'demo.save': 'Sichere deinen Fortschritt und komm in die Rangliste', 'demo.nick': 'Nick',
  'demo.create': 'Konto erstellen', 'demo.openapp': 'Trainer öffnen →',
  'demo.ok': 'Konto erstellt! Öffne den Trainer und melde dich mit deinem Nick an.',
  'demo.taken': 'Dieser Nick ist vergeben — versuch einen anderen', 'demo.short': 'Nick ≥ 2 Zeichen, PIN ≥ 4 Ziffern',
  'demo.net': 'Netzwerkfehler, versuch es erneut',
};
const fr: Dict = {
  ...
  'rating.nav': 'Classement', 'rating.title': 'Classement', 'rating.sub': 'Les plus rapides — par discipline et langue',
  'rating.disc': 'Discipline', 'rating.lang': 'Langue', 'rating.player': 'Joueur', 'rating.acc': 'Précision',
  'rating.loading': 'Chargement…', 'rating.empty': 'Pas encore de résultats — sois le premier ! Joue la compétition dans l’entraîneur.', 'rating.open': 'Ouvrir la compétition →',
  'disc.alpha_fwd': 'Alphabet A→Z', 'disc.alpha_rev': 'Alphabet Z→A', 'disc.words': 'Mots', 'disc.digits': 'Chiffres', 'disc.sprint': 'Sprint',
  'learn.nav': 'Apprendre', 'learn.title': 'Apprendre la dactylographie au toucher', 'learn.sub': 'Des guides sur la dactylographie, la vitesse et l’apprentissage — faits vérifiés, sans remplissage.',
  'learn.cta': 'S’entraîner dans l’app', 'learn.faq': 'Questions fréquentes', 'learn.sources': 'Sources',
  'demo.title': 'Essaie ici même', 'demo.sub': 'Tape la ligne ci-dessous — ressens comment ça marche, sans installer',
  'demo.ph': 'Tape ici…', 'demo.full': 'Ouvrir l’entraîneur complet',
  'demo.save': 'Sauvegarde ta progression et entre au classement', 'demo.nick': 'Pseudo',
  'demo.create': 'Créer un compte', 'demo.openapp': 'Ouvrir l’entraîneur →',
  'demo.ok': 'Compte créé ! Ouvre l’entraîneur et connecte-toi avec ton pseudo.',
  'demo.taken': 'Ce pseudo est pris — essaie un autre', 'demo.short': 'Pseudo ≥ 2 caractères, PIN ≥ 4 chiffres',
  'demo.net': 'Erreur réseau, réessaie',
};
const it: Dict = {
  ...
  'rating.nav': 'Classifica', 'rating.title': 'Classifica', 'rating.sub': 'I più veloci — per disciplina e lingua',
  'rating.disc': 'Disciplina', 'rating.lang': 'Lingua', 'rating.player': 'Giocatore', 'rating.acc': 'Precisione',
  'rating.loading': 'Caricamento…', 'rating.empty': 'Ancora nessun risultato — sii il primo! Gioca la competizione nel trainer.', 'rating.open': 'Apri la competizione →',
  'disc.alpha_fwd': 'Alfabeto A→Z', 'disc.alpha_rev': 'Alfabeto Z→A', 'disc.words': 'Parole', 'disc.digits': 'Cifre', 'disc.sprint': 'Sprint',
  'learn.nav': 'Impara', 'learn.title': 'Impara la dattilografia a tatto', 'learn.sub': 'Guide sulla dattilografia, la velocità e come imparare — fatti verificati, senza riempitivi.',
  'learn.cta': 'Allenati nel trainer', 'learn.faq': 'Domande frequenti', 'learn.sources': 'Fonti',
  'demo.title': 'Provalo proprio qui', 'demo.sub': 'Scrivi la riga qui sotto — senti come funziona, senza installare',
  'demo.ph': 'Scrivi qui…', 'demo.full': 'Apri il trainer completo',
  'demo.save': 'Salva i progressi ed entra in classifica', 'demo.nick': 'Nick',
  'demo.create': 'Crea account', 'demo.openapp': 'Apri il trainer →',
  'demo.ok': 'Account creato! Apri il trainer e accedi con il tuo nick.',
  'demo.taken': 'Questo nick è già preso — provane un altro', 'demo.short': 'Nick ≥ 2 caratteri, PIN ≥ 4 cifre',
  'demo.net': 'Errore di rete, riprova',
};
const pt: Dict = {
  ...
  'rating.nav': 'Ranking', 'rating.title': 'Ranking', 'rating.sub': 'Os mais rápidos — por disciplina e idioma',
  'rating.disc': 'Disciplina', 'rating.lang': 'Idioma', 'rating.player': 'Jogador', 'rating.acc': 'Precisão',
  'rating.loading': 'A carregar…', 'rating.empty': 'Ainda sem resultados — sê o primeiro! Joga a competição no treinador.', 'rating.open': 'Abrir competição →',
  'disc.alpha_fwd': 'Alfabeto A→Z', 'disc.alpha_rev': 'Alfabeto Z→A', 'disc.words': 'Palavras', 'disc.digits': 'Dígitos', 'disc.sprint': 'Sprint',
  'learn.nav': 'Aprender', 'learn.title': 'Aprende digitação por toque', 'learn.sub': 'Guias sobre digitação, velocidade e como aprender — factos verificados, sem enchimento.',
  'learn.cta': 'Praticar no treinador', 'learn.faq': 'Perguntas frequentes', 'learn.sources': 'Fontes',
  'demo.title': 'Experimenta aqui mesmo', 'demo.sub': 'Escreve a linha abaixo — sente como funciona, sem instalar',
  'demo.ph': 'Começa a escrever aqui…', 'demo.full': 'Abrir o treinador completo',
  'demo.save': 'Guarda o teu progresso e entra no ranking', 'demo.nick': 'Alcunha',
  'demo.create': 'Criar conta', 'demo.openapp': 'Abrir treinador →',
  'demo.ok': 'Conta criada! Abre o treinador e entra com a tua alcunha.',
  'demo.taken': 'Essa alcunha já existe — tenta outra', 'demo.short': 'Alcunha ≥ 2 caracteres, PIN ≥ 4 dígitos',
  'demo.net': 'Erro de rede, tenta de novo',
};
